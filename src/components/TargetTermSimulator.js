      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="amortType" className="block text-sm font-medium text-gray-700">
                Tipo de Amortização
              </label>
              <div className="mt-1">
                <select
                  id="amortType"
                  className="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
                  value={targetAmortType}
                  onChange={(e) => setTargetAmortType(e.target.value)}
                >
              ...
              <p className="mt-1 text-sm text-gray-500">
                Como você quer aplicar cada amortização extra?
              </p>
            </div>
        ...
        <div>
          {targetResults ? (
            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
              <div className="px-4 py-5 sm:px-6 bg-gradient-to-r from-green-50 to-emerald-50">
                <h3 className="text-lg leading-6 font-medium text-green-800">Resultado da Simulação</h3>
              ...
              <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
                <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                  <div>
                    <dt className="text-sm font-medium text-gray-500">Valor de Amortização Calculado</dt>
                  ...
                  <div>
                    <dt className="text-sm font-medium text-gray-500">Amortização Adicional Total</dt>
                    <dd className="mt-1 text-xl font-semibold text-gray-900">
                      {formatCurrency(targetResults.amortValue * targetResults.amortMonths.length)}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-sm font-medium text-gray-500">Prazo Solicitado</dt>
                    <dd className="mt-1 text-lg font-semibold text-gray-700">
                      {targetTerm} meses ({(targetTerm / 12).toFixed(1)} anos)
                    </dd>
                  </div>
                  <div>
                    <dt className="text-sm font-medium text-gray-500">Prazo Atingido</dt>
                  ...
                  {targetResults.savings && (
                    <>
                      <div className="sm:col-span-2">
                        <dt className="text-sm font-medium text-gray-500">Economia Total Estimada</dt>
                        <dd className="mt-1 text-2xl font-semibold text-green-600">
            ...
            <div className="bg-gray-50 rounded-lg p-6 h-full flex flex-col justify-center items-center">
              ...
              <h3 className="text-lg font-medium text-gray-700 mb-2">Como funciona?</h3>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <div className="rounded-md bg-blue-50 p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Dica para um bom planejamento:</h3>
              <div className="mt-2 text-sm text-blue-700">
                <p>
                  Para um planejamento de longo prazo, considere amortizações anuais.
                  Para um prazo curto, amortizações mensais ou trimestrais podem ser mais eficientes.
                </p>
              </div>
            </div>
          </div>
